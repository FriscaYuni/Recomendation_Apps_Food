...
class Article extends Equatable {
  ...
  static List<Article> articles = [
    Article(
      ...
      category: 'Jawa Timur',
      views: 298,
      imageUrl: 'https://i.ytimg.com/vi/AoW_NUwlx-0/maxresdefault.jpg',
    ...
    Article(
      ...
      views: 789,
      imageUrl:
          'https://www.reggaetom.com/wp-content/uploads/2021/07/macam-macam-masakan-rendang.jpg',
    ...
    Article(
      ...
      views: 129,
      imageUrl:
          'https://i.pinimg.com/originals/86/b3/47/86b347c77ee30355558f0aa39c32a9f2.jpg',
      createdAt: DateTime.now().subtract(const Duration(hours: 20)),
    ),
    Article(
      id: '7',
    ...
    Article(
      ...
      views: 500,
      imageUrl:
          'https://kurio-img.kurioapps.com/21/10/05/0e909e75-e031-4dd9-ae6c-5682fe8411af.jpe',
      createdAt: DateTime.now().subtract(const Duration(hours: 20)),
    ),
    Article(
      id: '9',
